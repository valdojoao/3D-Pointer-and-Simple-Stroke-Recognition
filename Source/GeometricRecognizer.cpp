...
namespace DollarRecognizer
{
	...
	void GeometricRecognizer::loadTemplates()
	{
		...
		//My own gestures
		addTemplate("fast_circles", samples.getGestureFastCircles());
		addTemplate("sequence_closed_hand", samples.getGestureSequenceClosedHand());		
		addTemplate("sequence_open_hand", samples.getGestureSequenceOpenHand());
		addTemplate("sequence_small_shapes", samples.getGestureSequenceSmallShapes());		
		
		addTemplate("circle_ccw", samples.getGestureCircleCcw());
		addTemplate("circle_ccw_far", samples.getGestureCircleCcwFar());		
		addTemplate("circle_ccw_hand", samples.getGestureCircleCcwHand());
		addTemplate("circle_sequence", samples.getGestureCircleSequence_2());
		addTemplate("rectangle_ccw", samples.getGestureRectangleccw());		
		addTemplate("rectangle_cw", samples.getGestureRectangleCw());
		addTemplate("star", samples.getGestureStar_2());		
		addTemplate("zigzag", samples.getGestureZigzag());

		/*
		addTemplate("Zigzag", samples.getGestureZigZag());
		addTemplate("Circle_CW", samples.getGestureCircle_CW());		
		addTemplate("Circle_CCW", samples.getGestureCircle_CCW());
		addTemplate("Circle_sequence", samples.getGestureCircleSequence());		
		addTemplate("Rectangle_CW", samples.getGestureRectangle_CW());
		addTemplate("Rectangle_CCW", samples.getGestureRectangle_CCW());		
		addTemplate("Star", samples.getGestureStar());*/
		
		/*addTemplate("Triangle_CW", samples.getGestureTriangle_CW());
		addTemplate("Triangle_CCW", samples.getGestureTriangle_CCW());
